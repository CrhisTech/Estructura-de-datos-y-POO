...
class Alumno():
    ...
    #2 Constructor (Uso del constructor)
    #Es un metodo el cual le permite a la clase, alimentarse de datos
    #El constructor es de ejecucion automatica
...
Carlos = Alumno(1000,"Carlos Rojas Peralta", "Ingles", 16, 17, 18, 15)
Carlos.Imprimir()
...
Crhistopher=Alumno(1001,"Crhistopher Capcha Gamarra", "Base de Datos", 18, 15, 17, 20)
...
Alberto=Alumno(1002, "Alberto Perales Mazza", "Programacion Orientada a Objetos", 15, 14, 17, 10)
Alberto.Imprimir()
